  ...
  return (
    <section id="projects" className="py-20 bg-[var(--bg-primary)] dark:bg-[var(--bg-secondary)]">
      <div className="max-w-6xl mx-auto px-8">
        <h2 className="text-5xl mb-8 text-center text-[var(--text-primary)] font-bold bg-gradient-to-r from-[#172554] to-[#172554] bg-clip-text text-transparent">
          Projects
        </h2>
        ...
        <div className="flex items-center justify-center gap-4 max-w-3xl mx-auto mb-12 px-8 py-4 bg-gradient-to-br from-[rgba(30,58,138,0.08)] to-[rgba(23,37,84,0.08)] rounded-full border-2 border-[rgba(30,58,138,0.2)] dark:from-[rgba(30,58,138,0.12)] dark:to-[rgba(23,37,84,0.12)] dark:border-[rgba(30,58,138,0.3)]">
          <FaCode className="text-2xl flex-shrink-0 text-[#172554]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            ...
            >
              ...
              <h3 className="text-2xl mb-4 text-[#172554] font-bold relative z-10 group-hover:text-[#172554] transition-colors">
                {project.title}
              </h3>
              ...
              <div className="flex gap-4 relative z-10">
                <a
                  ...
                  className="text-[#172554] font-semibold hover:text-[#172554] transition-colors inline-flex items-center gap-2 group-hover:gap-3 transition-all"
                >
                  <FaGithub /> GitHub
                </a>
              </div>
