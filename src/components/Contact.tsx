          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {contactLinks.map((link) => (
                ...
                >
                  <div className="w-[52px] h-[52px] rounded-full bg-gradient-to-br from-[#667eea] to-[#764ba2] flex items-center justify-center text-2xl text-white transition-all duration-300 group-hover:scale-110 group-hover:rotate-[5deg] group-hover:shadow-[0_8px_20px_rgba(102,126,234,0.5)]">
                    {link.icon}
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-[var(--text-secondary)] text-xs m-0 opacity-70 flex items-center justify-center gap-1">
              Crafted with <FaHeart className="text-[#667eea]" /> and <FaCoffee className="text-[#764ba2]" />
            </p>
          </div>
        </div>
      </footer>
