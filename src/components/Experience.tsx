const experiences = [
  {
    ...
    achievements: [
      'Automated Kubernetes-native CI/CD workflows using Tekton, streamlining deployment processes for critical services',
      'Integrated Behave automated testing into Tekton CI/CD pipelines, reducing manual debugging effort by ~30% and improving deployment reliability',
  ...
  },
  {
    ...
    achievements: [
      'Developed a cloud security scanning application using Docker and Kubernetes to improve container platform security and vulnerability assessment workflows',
      'Integrated security scanning tools into CI/CD pipelines, improving vulnerability detection across deployment stages',
      'Diagnosed deployment and runtime issues while authoring technical documentation to support system reliability and onboarding processes',
    ],
