  ...
  return (
    <section id="experience" className="py-20 bg-[var(--bg-primary)] relative dark:bg-[var(--bg-secondary)]">
      <div className="max-w-6xl mx-auto px-8">
        <h2 className="text-5xl mb-8 text-center text-[var(--text-primary)] relative after:content-[''] after:absolute after:bottom-[-1rem] after:left-1/2 after:-translate-x-1/2 after:w-20 after:h-1 after:bg-gradient-to-r after:from-[#172554] after:to-[#172554] after:rounded-sm">
          Work Experience
        </h2>
        ...
        <div className="flex items-center justify-center gap-4 max-w-3xl mx-auto mb-12 px-8 py-4 bg-gradient-to-br from-[rgba(30,58,138,0.08)] to-[rgba(23,37,84,0.08)] rounded-full border-2 border-[rgba(30,58,138,0.2)] dark:from-[rgba(30,58,138,0.12)] dark:to-[rgba(23,37,84,0.12)] dark:border-[rgba(30,58,138,0.3)]">
          <FaBriefcase className="text-2xl flex-shrink-0 text-[#172554]" />
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="bg-[var(--card-bg)] p-8 rounded-2xl shadow-[0_4px_15px_var(--shadow)] border-l-4 border-[#172554] transition-all hover:-translate-y-1 hover:shadow-[0_8px_25px_var(--shadow)]"
            >
              <div className="mb-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[var(--text-secondary)]">
                  <p className="text-lg font-medium text-[#172554] m-0">
                    {exp.company}
                  </p>
                ...
                <p className="text-sm text-[var(--text-secondary)] mt-1 m-0 flex items-center gap-1">
                  <FaMapMarkerAlt className="text-[#172554]" /> {exp.location}
                </p>
              </div>
              ...
              <ul className="space-y-3 list-none pl-0">
                {exp.achievements.map((achievement, idx) => (
                  ...
                  >
                    <FaChevronRight className="text-[#172554] text-xs mt-1.5 flex-shrink-0" />
