  ...
  return (
    <section id="education" className="py-20 bg-[var(--bg-secondary)] dark:bg-[var(--bg-primary)]">
      <div className="max-w-6xl mx-auto px-8">
        <h2 className="text-5xl mb-8 text-center text-[var(--text-primary)] font-bold relative after:content-[''] after:absolute after:bottom-[-1rem] after:left-1/2 after:-translate-x-1/2 after:w-20 after:h-1 after:bg-gradient-to-r after:from-[var(--color-primary)] after:to-[var(--color-primary)] after:rounded-sm">
          Education
        </h2>
        ...
        <div className="flex items-center justify-center gap-4 max-w-3xl mx-auto mb-12 px-8 py-4 bg-gradient-to-br from-[rgba(30,58,138,0.08)] to-[rgba(23,37,84,0.08)] rounded-full border-2 border-[rgba(30,58,138,0.2)] dark:from-[rgba(30,58,138,0.12)] dark:to-[rgba(23,37,84,0.12)] dark:border-[rgba(30,58,138,0.3)]">
          <FaGraduationCap className="text-2xl flex-shrink-0 text-[var(--color-primary)]" />
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          {/* Kingston University */}
          <div className="bg-[var(--card-bg)] p-8 rounded-2xl shadow-[0_4px_15px_var(--shadow)] border-l-4 border-[var(--color-primary)] transition-all hover:-translate-y-1 hover:shadow-[0_8px_25px_var(--shadow)]">
            <div className="mb-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[var(--text-secondary)]">
                <p className="text-lg font-medium text-[var(--color-primary)] m-0">Kingston University, London, UK</p>
              ...
              <p className="text-sm text-[var(--text-secondary)] mt-1 m-0 flex items-center gap-1">
                <FaMapMarkerAlt className="text-[var(--color-primary)]" /> Delivered via ESOFT UNI (ESU), Sri Lanka
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {['Software Engineering', 'Web Application Development', 'Research & Data Analysis'].map((c) => (
                  <span key={c} className="px-3 py-1 bg-[rgba(30,58,138,0.1)] text-[var(--color-primary)] rounded-full text-sm font-medium border border-[rgba(30,58,138,0.25)]">{c}</span>
                ))}
              </div>
            </div>
          ...
          <div className="bg-[var(--card-bg)] p-8 rounded-2xl shadow-[0_4px_15px_var(--shadow)] border-l-4 border-[var(--color-primary)] transition-all hover:-translate-y-1 hover:shadow-[0_8px_25px_var(--shadow)]">
            <div className="mb-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[var(--text-secondary)]">
                <p className="text-lg font-medium text-[var(--color-primary)] m-0">Maliyadeva College</p>
              </div>
              <p className="text-sm text-[var(--text-secondary)] mt-1 m-0 flex items-center gap-1">
                <FaMapMarkerAlt className="text-[var(--color-primary)]" /> Kurunegala, Sri Lanka
              </p>
            </div>
